...
function RootNavigator() {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name='SchedulePage' component={SchedulePageNavigator}/>
...
function BottomTabNavigator() {
  ...
  return (
      <BottomTab.Navigator
          ...
          <BottomTab.Screen
              name='TabOne'
              component={SchedulePageNavigator}
...
function SchedulePageNavigator() {
    return (
      <SchedulePage.Navigator>
          <SchedulePage.Screen name='Main' component={ScheduleMainScreen}/>
